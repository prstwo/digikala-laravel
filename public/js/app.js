...
if (window.innerWidth > 680) {
  var showBrands = function showBrands(n) {
    var i;
    var brands = document.querySelectorAll(".swiper-brands-image-container");
  ...
  var moveBrands = function moveBrands(n) {
