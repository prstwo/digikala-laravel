...
var carouselSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__.default('.swiper-container-carousel', {
  slidesPerView: 1,
  spaceBetween: 1,
  slidesPerGroup: 1,
  loop: true,
...
var swiperM2 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__.default('.swiper-container-mobile-2', {
  slidesPerView: 1,
  spaceBetween: 30,
  slidesPerGroup: 1,
  loop: true,
...
var swiperM3 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__.default('.swiper-container-mobile3', {
  slidesPerView: 2,
  spaceBetween: 8,
  slidesPerGroup: 2,
  loop: true,
...
var mySwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__.default('.swiper-instant-offers', {
  speed: 1000,
...
var observerReviews = new IntersectionObserver(function (entries) {
  if (entries[0].isIntersecting === true) {
    document.querySelectorAll('.o-box-tab').forEach(function (e) {
...
setInterval(function () {
  ...
  document.querySelectorAll('.specials .counter-day').forEach(function (daysSec) {
    daysSec.innerText = days2;
  });
  document.querySelectorAll('.specials .counter-hour').forEach(function (hoursSec) {
    hoursSec.innerText = hours2;
  });
  document.querySelectorAll('.specials .counter-minute').forEach(function (minutesSec) {
    minutesSec.innerText = minutes2;
  });
  document.querySelectorAll('.specials .counter-second').forEach(function (secondsSec) {
