<div class="container hidden md:block px-6 py-0 bg-white">
    ...
    <div class="product-suppliers mb-3">
        <div class="box-suppliers-head">
            <x-head-sec mobileTitle="لیست فروشندگان این کالا" title="لیست فروشندگان این کالا" headlink="" />
        ...
        <div class="suppliers-list">
            <x-suppliers seller="ایرانیان قایم همراه کاوش تیم" rate="۴.۴"
                         ...
                         sendover50="over50" sendnum="p99" sendrate="99%"
                         returnover50="over50" returnnum="p93" returnrate="93%" rezayatpercent="۹۵"
                         people="۴" raziwith="50%" kamelanraziwith="50%" naraziwith="0%"/>
            <x-suppliers seller="دیجی کالا" rate="۵"
                         ...
                         returnover50="over50" returnnum="p90" returnrate="90%" rezayatpercent="۹۸"
                         people="۸۵" raziwith="75%" kamelanraziwith="25%" naraziwith="0%"/>
        </div>
    </div>
